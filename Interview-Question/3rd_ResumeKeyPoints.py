...
Example:
✅ "Motivated Data Analyst with a strong foundation in Python and its libraries. Experienced in web development, problem-solving, and data visualization. Passionate about creating data-driven solutions and eager to grow within a dynamic team."
'''

# 3. Formatting Tips for Readability
'''
Font Sizes:
✅ Main Headings (e.g., Experience, Education): 14–16 pt (Bold)
✅ Subheadings (e.g., Job Titles, Project Names): 12–14 pt (Bold or Semi-Bold)
✅ Content (e.g., Descriptions, Responsibilities): 10–12 pt (Regular)
...
✅ Full Stack Web Development – Car Rental System
...
'''
Skill Types:
✅ Soft Skills --> Personal attributes that help in workplace interactions (e.g., communication, leadership, adaptability).
✅ Hard Skills --> Technical or job-specific abilities (e.g., Python programming, data analysis, Excel proficiency).

Since problem-solving, teamwork, and creative thinking relate to how you interact, think, and work in a team, 
they fall under soft skills. However, they are highly valued in technical roles as well! 🚀
'''
